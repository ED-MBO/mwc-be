        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/HorlogesController/update/<?= $data['horloge']->Id; ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" min="0" step="0.01" class="form-control <?= isset($data['errors']['prijs']) ? 'is-invalid' : ''; ?>" id="prijs"
                ...
                <div class="mb-3">
                    ...
                    <input name="gewicht" type="number" min="0" class="form-control <?= isset($data['errors']['gewicht']) ? 'is-invalid' : ''; ?>" id="gewicht"
                ...
                <div class="mb-3">
                    ...
                    <input name="waterdichtheid" type="text" class="form-control <?= isset($data['errors']['waterdichtheid']) ? 'is-invalid' : ''; ?>" id="waterdichtheid"
                ...
                <div class="mb-3">
                    ...
                    <input name="type" type="text" class="form-control <?= isset($data['errors']['type']) ? 'is-invalid' : ''; ?>" id="type"
                ...
                <div class="mb-3">
                    ...
                    <input name="uniekkenmerk" type="text" class="form-control <?= isset($data['errors']['uniekkenmerk']) ? 'is-invalid' : ''; ?>" id="uniekkenmerk"
