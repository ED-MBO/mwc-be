        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SmartphoneController/update/<?= $data['smartphone']->Id; ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" min="0" max="9999" step="0.01" class="form-control <?= isset($data['errors']['prijs']) ? 'is-invalid' : ''; ?>" id="prijs" 
                ...
                <div class="mb-3">
                    ...
                    <input name="geheugen" type="number" min="0" max="4000" class="form-control <?= isset($data['errors']['geheugen']) ? 'is-invalid' : ''; ?>" id="geheugen" 
                ...
                <div class="mb-3">
                    ...
                    <input name="schermgrootte" type="number" min="0" max="10" step="0.01" class="form-control <?= isset($data['errors']['schermgrootte']) ? 'is-invalid' : ''; ?>" id="schermgrootte" 
                ...
                <div class="mb-3">
                    ...
                    <input name="megapixels" type="number" min="0" max="200" class="form-control <?= isset($data['errors']['megapixels']) ? 'is-invalid' : ''; ?>" id="megapixels" 
